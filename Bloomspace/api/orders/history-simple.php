<?php
/**
 * Simple Order History API
 * Get order history for the current user (without order items for now)
 */
...
try {
    ...
    // Process orders (without order items for now)
    foreach ($orders as &$order) {
        // Set empty items array for now
        $order['items'] = [];
